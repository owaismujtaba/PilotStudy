...
class NeuralDatasetExtractor:
    ...
    def __init__(self, 
        ...
        print("\n" + "=" * 60)
        print("🚀 Initializing NeuralDatasetExtractor 🚀".center(60))
        print("=" * 60 + "\n")
    ...
    def preprocessData(self):
        ...
        """
        print("\n" + "=" * 60)
        print("🔧 Applying preprocessing steps to the raw EEG data 🔧".center(60))
        print("=" * 60 + "\n")
    ...
    def _getListOfSyllablesAndWords(self):
        ...
        """
        print("\n" + "=" * 60)
        print("📜 Getting list of syllables and words 📜".center(60))
        print("=" * 60 + "\n")
    ...
    def extractEegDataForWords(self):
        ...
        """
        print('\n' + '=' * 60)
        print("🧠 Extracting EEG data for words 🧠".center(60))
        print('=' * 60 + '\n')   
    ...
    def extractEegDataForSyllables(self):
        ...
        """
        print('\n' + '=' * 60)
        print("🧠 Extracting EEG data for syllables 🧠".center(60))
        print('=' * 60 + '\n')
...
class WordSyllableDataExtractor:
    ...
    def __init__(self, 
        ...
        print("\n" + "=" * 60)
        print("🚀 Initializing WordSyllableDatasetExtractor 🚀".center(60))
        print("=" * 60 + "\n")
    ...
    def extractWordData(self):
        print('\n' + '=' * 60)
        print(f"📝 Extracting word data for subject {self.subjectId}, session {self.sessionId} 📝".center(60))
        print('=' * 60 + '\n')
    ...
    def extractSyllableData(self):
        print('\n' + '=' * 60)
        print(f"📝 Extracting syllable data for subject {self.subjectId}, session {self.sessionId} 📝".center(60))
        print('=' * 60 + '\n')
...
def extractWordSyllableDataForAllSubjects(
    ...
    for subject in [dir for dir in os.listdir(rootDir) if os.path.isdir(Path(rootDir, dir))]:
        ...
        for session in [dir for dir in os.listdir(subjectPath) if os.path.isdir(Path(subjectPath, dir))]:
            ...
            print("\n" + "=" * 60)
            print(f"📊 Extracting data for subject {subjectId}, session {sessionId} 📊".center(60))
            print("=" * 60)
